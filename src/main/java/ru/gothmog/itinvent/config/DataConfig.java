package ru.gothmog.itinvent.config;
...
@ComponentScan({"ru.gothmog.itinvent.config"})
@PropertySource(value = {"classpath:db.properties"})
@EnableJpaRepositories(basePackages = {"ru.gothmog.itinvent.repository"}, entityManagerFactoryRef = "entityManagerFactoryBean")
